...
class Spider_Model:
    ...
    def getDetails(self,name,url):
        ...
        for i in range(0,len(teamDraft)):
            if "All Teams" in teamDraft[i][1]:
                team.append("All Teams")
            else:
        ...
        for j in range(0,len(team)):
            ...
            player = Players(name,id,performanceByYear)
...
class Players:
    ...
    def __init__(self,name,id,performanceByYear):
        self.name = name
        self.id = id
